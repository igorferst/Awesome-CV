  ...
  \cventry
    ...
    {Sept. 2014 - present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Evangelized and trained team on new technologies (Docker, Angular), development processes (TDD, code reviews, release process) and agile methodology (sprints, estimation, user stories).}
        ...
        \item {Solved difficult, high-impact technical problems: designed and implemented sophisticated graph algorithm for advanced analytics over healthcare claims data, created DSL for user-defined computations over claims data, designed and supervised implementation of platform-wide role-based authorization framework.}
        \item {Worked closely with VP of Engineering to grow developer team from 4 to 13: overhauled interview process to emphasize rigor and consistency, wrote job descriptions, defined onboarding process and onboarded most new developers.}
      \end{cvitems}
    }
